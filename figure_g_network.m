...
% text g1 g2
text(ax, tbg.g1(1)/2, tbg.g1(2)/2, 'g_2 ', 'FontSize', 18,...
    'HorizontalAlignment','right');
text(ax, tbg.g2(1)/2, tbg.g2(2)/2, '   g_1', 'FontSize', 18);
...
text(ax, -ts(1,2)+t_center(1), -ts(2,2)+t_center(2), ' -t_2', 'FontSize',18);
text(ax, -ts(1,3)+t_center(1), -ts(2,3)+t_center(2), '-t_3 ', 'FontSize',18,...
    'HorizontalAlignment','right');
